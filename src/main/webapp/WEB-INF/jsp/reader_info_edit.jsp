...
<body background="img/wolf2.jpg" style=" background-repeat:no-repeat ;
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="reader_edit_do_r.html" method="post" id="edit" >
                ...
                <br/>
                <div align="center"><input type="submit" value="确定" class="btn btn-success btn-sm" class="text-left"></div>
                <script>
