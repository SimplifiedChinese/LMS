...
<body background="img/s3.jpg" style=" background-repeat:no-repeat ;
background-size:100% 100%;
background-attachment: fixed;">

<div id="header"></div>
<div style="position: relative;padding-top: 60px; width: 40%;margin-left: 30%">
    <form action="book_add_do.html" method="post" id="addbook">
        ...
        </br><div align="center"><input type="submit" value="添加" class="btn btn-success btn-sm" class="text-left" draggable="true"></div>
        <script>
